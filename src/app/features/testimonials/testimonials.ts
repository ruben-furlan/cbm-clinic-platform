...
import { GoogleReviewsService, TestimonialItem } from '../../core/services/google-reviews.service';
...
export class Testimonials implements OnInit, OnDestroy {
  ...
  async ngOnInit(): Promise<void> {
    ...
    const data = await this.googleReviews.load();
    this.placeName = data.placeName;
    this.averageRating = data.averageRating;
    this.totalRatings = data.totalRatings;
    this.testimonials = data.testimonials;
    this.loadedFromGoogle = data.fromGoogle;
